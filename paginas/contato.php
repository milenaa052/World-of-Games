<section class="contato">
    ...
    <form action="" class="card d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-sine">
        <div class="campos mb-3 col-6 w-100">
            <label for="nome" class="form-label">Nome</label>
            <input type="text" class="form-control fw-bold" id="nome" placeholder="Digite o seu nome" required>
        </div>
        ...
        <div class="campos mb-3 col-6 w-100">
            ...
            <textarea class="form-control fw-bold" id="mensagem" rows="3" placeholder="Digite a sua mensagem" required></textarea>
        </div>
